/*Yetii - Yet (E)Another Tab Interface Implementation,version 1.5,http://www.kminek.pl/lab/yetii/,Copyright (c) 2007-2008 Grzegorz Wojcik,Code licensed under the BSD License: http://www.kminek.pl/bsdlicense.txt*/ function Yetii() {
  this.defaults = {
    id: null,
    active: 1,
    interval: null,
  ...
  this.getTabs = function () {
    ...
    var c = new RegExp(
      "(^|\\s)" + this.defaults.tabclass.replace(/\-/g, "\\-") + "(\\s|$)"
    );
  ...
  this.links = document
    .getElementById(this.defaults.id + "-nav")
  ...
  this.defaults.active = this.parseurl(this.defaults.id)
    ? this.parseurl(this.defaults.id)
    : this.defaults.active;
